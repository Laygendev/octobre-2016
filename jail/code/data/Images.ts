...
module Data {
  export class Images {
    ...
    static buttons: any = undefined;
    static backgrounds: any = undefined;
    static staticImages: any = undefined;
    ...
    static LoadMapButton(cb: () => void):void {
